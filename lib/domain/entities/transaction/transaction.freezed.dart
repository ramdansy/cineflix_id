...
mixin _$Transaction {
  ...
  int? get ticketPrioce => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      ticketAmount: freezed == ticketAmount
          ...
          : ticketAmount // ignore: cast_nullable_to_non_nullable
              as int?,
      ticketPrioce: freezed == ticketPrioce
          ? _value.ticketPrioce
          : ticketPrioce // ignore: cast_nullable_to_non_nullable
              as int?,
...
class _$TransactionImpl implements _Transaction {
  ...
  @override
  String toString() {
    return 'Transaction(id: $id, uid: $uid, transactionTime: $transactionTime, transactionImage: $transactionImage, title: $title, seats: $seats, theaterName: $theaterName, watchingTime: $watchingTime, ticketAmount: $ticketAmount, ticketPrioce: $ticketPrioce, adminFee: $adminFee, total: $total)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.ticketPrioce, ticketPrioce) ||
                other.ticketPrioce == ticketPrioce) &&
